...
import { faDumbbell, faHouse, faGlobe, faStore, faShirt } from '@fortawesome/free-solid-svg-icons';
...
export default function Layout() {
  return (
    <View style={{ flex: 1, backgroundColor: "transparent" }}>
      ...
      <StatusBar backgroundColor="transparent" translucent barStyle="light-content" hidden />
